...
import { registerListeners as registerAppListeners } from '#pkg/platform/electron/ipc/electron-main/app';
import { registerListeners as registerFileDragStartListeners } from '#pkg/platform/electron/ipc/electron-main/file-drag-start';
import { registerListeners as registerPersistentStoreListeners } from '#pkg/platform/electron/ipc/electron-main/persistent-store';
import { registerListeners as registerShellListeners } from '#pkg/platform/electron/ipc/electron-main/shell';
import { registerListeners as registerWindowListeners } from '#pkg/platform/electron/ipc/electron-main/window';
import {
...
import { startFileExplorerAgent } from '#pkg/platform/electron/file-explorer-agent/initialize-file-explorer-agent';
